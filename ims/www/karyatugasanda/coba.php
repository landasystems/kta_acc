    ...
    <tbody>
        <tr>
            ...
            <td class="print" style="text-align: center" width="60%">
                <h4 style="line-height: 10px">BUKTI PENERIMAAN</h4>
        ...
        <tr>
            <td align="left" class="print" colspan="3">Diterima Dari : {description_to}</td>
        </tr>
    </tbody>
</table>
<div>{detail_cash}</div>
<table class="tbPrint">
    <tbody>
        <tr>
            ...
            <td class="print">No. : {description_giro_an}</td>
        </tr>
        <tr align="left">
        ...
        <tr>
            ...
            <td class="print" style="text-align:center" width="33%">Diserahkan Oleh</td>
        </tr>
        <tr height="100">
            <td class="print">&nbsp;</td>
            <td class="print">&nbsp;</td>
