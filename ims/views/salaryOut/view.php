<?php
$this->setPageTitle('Lihat Penggajian | ID : ' . $model->id);
    ...
    <div class="box gradient invoice">
        <div class="title clearfix">
            ...
            <div class="invoice-info">
                ...
                <div class="print">
                    <a href="#" class="tip" oldtitle="Print invoice" title="" aria-describedby="ui-tooltip-7"><span class="icon16 icomoon-icon-newspaper"></span></a>
                </div>
            </div>
        ...
        <div class="content ">        
            ...
            <div class="content_detail">
                ...
                echo $this->renderPartial('_salaryDetail', array('salary' => $salary));
                ?>
            </div>
        </div>
