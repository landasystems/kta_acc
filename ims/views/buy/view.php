<?php
$this->setPageTitle('Lihat Buys | ID : ' . $model->id);
...
$this->widget('bootstrap.widgets.TbMenu', array(
    'type' => 'pills',
    'items' => array(
        array('visible' => landa()->checkAccess('Buy', 'c'),'label' => 'Tambah', 'icon' => 'icon-plus', 'url' => Yii::app()->controller->createUrl('create'), 'linkOptions' => array()),
            ...
            <div class="print">
                ...
                <div id="myModal" style="width: 740px" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-header">
                        ...
                        <h3 id="myModalLabel">Invoice BUY</h3>
                    </div>
                    <div class="modal-body">
                        <div class="printableArea">
                            ...
                            $city = City::model()->findByPk($model->ProductSupplier->city_id);
                            ...
                            $content = $siteConfig->report_buy;
                            $content = str_replace('{invoice}', $model->code, $content);
                            $content = str_replace('{name}', $model->ProductSupplier->name, $content);
                            $content = str_replace('{city}', $city->name, $content);
                            $content = str_replace('{province}', $city->Province->name, $content);
                            $content = str_replace('{address}', $model->ProductSupplier->address, $content);
                            $content = str_replace('{phone}', $model->ProductSupplier->phone, $content);
