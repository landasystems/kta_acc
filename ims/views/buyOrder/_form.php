                        ...
                        <span id="top_form_a">
                            <div class="row-fluid">
                                ...
                                <div class="span8" style="text-align:left">
                                    ...
                                    echo CHtml::dropDownList('BuyOrder[supplier_id]', $model->supplier_id, CHtml::listData($array, 'id', 'name'), array(
                                        'empty' => t('choose', 'global'),
                                        'class' => 'span10',
                                        'ajax' => array(
                                            'type' => 'POST',
                                            'url' => url('buyOrder/info'),
                ...
                <tbody>
                    <tr>
                        <td>
                            <?php
                            echo CHtml::ajaxLink(
                                    $text = '<i class="icon-plus-sign"></i>', $url = url('buyOrder/addRow'), $ajaxOptions = array(
                                'type' => 'POST',
                                'success' => 'function(data){ 
                            ...
                            $this->widget('bootstrap.widgets.TbSelect2', array(
                                ...
                                'events' => array('change' => 'js: function() {
                                                     $.ajax({
                                                        ...
                                                        type : "POST",
                                                        data :  { product_id:  $(this).val(), departement_id: $("#BuyOrder_departement_id").val()},
                                                        success : function(data){
                                                            obj = JSON.parse(data);
...
//                                    'oninput'=>'js:calculate()'
                    ...
                    if ($model->isNewRecord == FALSE) {
                        foreach ($mBuyOrderDet as $o) {
                            ...
                            echo '<tr>                               
                        <td>
                            <input type="hidden" name="BuyOrderDet[product_id][]" value="' . $o->product_id . '"/>
                            <input type="hidden" name="BuyOrderDet[price][]" value="' . $o->price . '"/>
                            <input type="hidden" name="BuyOrderDet[qty][]" value="' . $o->qty . '"/>
                            <input type="hidden" name="BuyOrderDet[total][]" class="detTotal" value="' . $o->price * $o->qty . '"/>
