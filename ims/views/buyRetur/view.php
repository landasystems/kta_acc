<?php
$this->setPageTitle('Lihat Buy Returs | ID : ' . $model->id);
$this->breadcrumbs = array(
    'Buy Returs' => array('index'),
    $model->id,
);
?>
            ...
            <div class="print">
                ...
                <div id="myModal" style="width: 740px" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-header">
                        ...
                        <h3 id="myModalLabel">Invoice BUY RETUR</h3>
                    </div>
                    <div class="modal-body">
                        <div class="printableArea">
                            <?php
                            $details = $mBuyReturDet;
                            ...
                            $detailProduct .=
                                    '   <br>
                                        ...
                                        <div style="float:left;padding:7px 5px;text-align:left;width:400px"></div>  
                                        <div style="float:left;padding:7px 5px;text-align:left;width:100px">Other Cost</div>                          
