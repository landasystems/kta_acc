...
/**
 * This is the model class for table "{{buy_order}}".
 *
 * The followings are the available columns in table '{{buy_order}}':
 * @property integer $id
...
class BuyOrder extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('departement_id, supplier_id, date_delivery', 'required'),
            array('subtotal, discount, ppn, other', 'numerical'),
            array('code, description', 'length', 'max' => 255),            
            array('created, modified', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, status,code, departement_id, created, created_user_id, modified, supplier_id, description, subtotal, discount, ppn, other, dp, credit, payment', 'safe', 'on' => 'search'),
        );
    }
