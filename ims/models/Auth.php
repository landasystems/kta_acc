...
//    }
    ...
    public function modules($arg = NULL) {
        ...
        return array(
            ...
            array('visible'=>(landa()->checkAccess('Report_Jurnal', 'r') || anda()->checkAccess('Report_Kasharian', 'r') || landa()->checkAccess('Report_Generalledger', 'r') || landa()->checkAccess('Report_NeracaSaldo', 'r')),'label' => '<span class="icon16 cut-icon-printer-2"></span>Laporan', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
